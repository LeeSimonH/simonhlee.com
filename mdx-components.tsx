...
const components = {
  ...
  // NOTE: everything below this comment is from Lee Robinson's mdx blog template
  h1: (props: HeadingProps) => <h1 className="mb-0 pt-12 font-medium" {...props} />,
  h2: (props: HeadingProps) => <h2 className="text-primary mt-8 mb-3 font-medium" {...props} />,
  h3: (props: HeadingProps) => <h3 className="text-primary mt-8 mb-3 font-medium" {...props} />,
  h4: (props: HeadingProps) => <h4 className="font-medium" {...props} />,
  p: (props: ParagraphProps) => (
    <p className="text-primary dark:text-secondary leading-snug" {...props} />
  ),
  ol: (props: ListProps) => (
    <ol className="text-primary dark:text-secondary list-decimal space-y-2 pl-5" {...props} />
  ),
  ul: (props: ListProps) => (
    <ul className="text-primary dark:text-secondary list-disc space-y-1 pl-5" {...props} />
  ),
